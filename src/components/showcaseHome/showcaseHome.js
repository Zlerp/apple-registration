...
import './showcaseHome.scss';
import CountUp from "react-countup";
import {Link} from "react-router-dom";

export default function ShowcaseHome(props) {

    return (
        <div className="showcase">
            <Link className="showcase__clickbox" to="/menu" />
            <div className="showcase__body d-flex justify-content-center align-content-center flex-column">
                <div className="showcase__body__logo">
                    <svg
                ...
                <h2 className="showcase__body__title">New Products Coming This Summer</h2>

                <div className="showcase__body__counter">
                    <CountUp end={2019} />
                </div>
            </div>
        </div>
