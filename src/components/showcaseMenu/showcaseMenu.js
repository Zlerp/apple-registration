...
import './showcaseMenu.scss';

export default function ShowcaseMenu(props) {
    return (
        <div className="showcase-menu">
            <div className="showcase-menu__body d-flex justify-content-center align-content-center flex-column">
                <div className="showcase-menu__body__logo">
                    <svg
                ...
                <h2 className="showcase-menu__body__title">Welcome to Apple</h2>
                <a className='showcase-menu__body__link' href="/#">See our Products</a>
                <div className="showcase-menu__body__products">
                    <a href="/#" className="product__link mx-2">
